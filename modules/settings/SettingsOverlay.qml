...
Scope {
    ...
    property var overlaySearchIndex: [
        ...
        // Interface (page 5)
        { pageIndex: 5, pageName: overlayPages[5].name, section: Translation.tr("Display scaling"), label: Translation.tr("Shell scale"), description: Translation.tr("Scale the entire shell UI for HiDPI / 4K monitors"), keywords: ["scale", "dpi", "hidpi", "4k", "zoom", "size", "display", "monitor", "resolution"] },
